...
export class AuthService extends BaseService {
   ...
   */
  public changePasswordApiV1AuthChangePasswordPatch(
  ...
  public changePasswordApiV1AuthChangePasswordPatch(
    ...
    if (changePasswordRequest === null || changePasswordRequest === undefined) {
      throw new Error(
        'Required parameter changePasswordRequest was null or undefined when calling changePasswordApiV1AuthChangePasswordPatch.',
      );
    }
  ...
  ): Observable<HttpResponse<UserRead>>;
  public loginApiV1AuthLoginPost(
    loginRequest: LoginRequest,
    observe?: 'events',
    reportProgress?: boolean,
   ...
   * @param options additional options
   */
  public logoutApiV1AuthLogoutPost(
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: 'application/json';
